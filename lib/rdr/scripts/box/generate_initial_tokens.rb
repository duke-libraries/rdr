# Copied, with minor modifications, from 'https://github.com/cburnette/boxr/blob/master/examples/oauth.rb'.
...
When you are finished your browser will probably redirect to an error page. This is expected behavior. Look at the URL in the address \
