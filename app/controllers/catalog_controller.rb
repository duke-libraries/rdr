  ...
  configure_blacklight do |config|
    ...
    config.add_search_field('all_fields', label: 'All Fields') do |field|
      ...
      field.solr_parameters = {
        ...
        qf: [ solr_name("affiliation", :stored_searchable),
              solr_name("alternative", :stored_searchable),
              solr_name("ark", :stored_searchable),
              solr_name("available", :stored_searchable),
              solr_name("based_near_label", :stored_searchable),
              solr_name("bibliographic_citation", :stored_searchable),
              solr_name("contact", :stored_searchable),
              solr_name("contributor", :stored_searchable),
              solr_name("creator", :stored_searchable),
              solr_name("date_created", :stored_searchable),
              solr_name("description", :stored_searchable),
              solr_name("doi", :stored_searchable),
              solr_name("format", :stored_searchable),
              solr_name("funding_agency", :stored_searchable),
              solr_name("grant_number", :stored_searchable),
              solr_name("identifier", :stored_searchable),
              solr_name("keyword", :stored_searchable),
              solr_name("label", :stored_searchable),
              solr_name("language", :stored_searchable),
              solr_name("license", :stored_searchable),
              solr_name("provenance", :stored_searchable),
              solr_name("publisher", :stored_searchable),
              solr_name("related_url", :stored_searchable),
              solr_name("relative_path", :stored_searchable),
              solr_name("resource_type", :stored_searchable),
              solr_name("rights_note", :stored_searchable),
              solr_name("rights_statement", :stored_searchable),
