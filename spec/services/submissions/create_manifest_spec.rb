  ...
  RSpec.describe CreateManifest do
    ...
    describe '#call' do
      ...
      context 'creates a manifest file using CC0 license' do
        let(:submission) { Submission.new(
            {title: "Title of Work_A",
             ...
             subject: "stuff; more stuff",
             based_near: "London, England_A",
             doi: "123456789_A",
             using_cc0: Submission::USE_CC0
            }) }
        let(:header_row) { ["title", "creator", "creator", "affiliation", "subject", "subject",
                            "based_near", "doi", "license"] }
        let(:data_row) { ["Title of Work_A", "Author1Last_A, Author1First_A", "Author2Last_A, Author2First_A",
                          "institutionXYZ_A", "stuff", "more stuff", "London, England_A","123456789_A",
                          CreateManifest::CC0_LICENSE ] }
      ...
      context 'creates a manifest file not using CC0 license' do
        ...
        let(:header_row) { ["title", "creator", "creator", "affiliation", "subject", "subject",
                            "based_near", "doi", "license"] }
        let(:data_row) { ["Title of Work_B", "Author1Last_B, Author1First_B", "Author2Last_B, Author2First_B",
                          "institutionXYZ_B", "stuff", "more stuff", "London, England_B","123456789_B",
